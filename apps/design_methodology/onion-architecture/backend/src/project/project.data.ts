...
export const initialStudyMemos = [
  {
    "id": "seed-1",
    "title": "Onion Architecture 기준 첫 메모",
    "goal": "시스템을 어떤 책임 경계로 나눌 것인가를 Onion Architecture 관점으로 본다.",
    "decision": "Onion Architecture로 먼저 단일 구조를 이해한 뒤 조합형으로 확장한다.",
    "notes": "Onion Architecture 패턴은 Design Methodology 카테고리 안에서 독립 프로젝트로 학습한다.",
