        ...
        <Stack gap="var(--va-space-24)">
          ...
          <ContentGrid>
            <Stack gap="var(--va-space-20)">
              <Section title="Project overview" description="현재 비교형 접근 제어 프로젝트 설명과 기술 스택입니다." action={
              ...
              <Section title="Study memos" description="비교형 프로젝트 메모를 저장합니다.">
                <Stack gap="var(--va-space-16)">
                  ...
                  <MemoList>
                    ...
                    {!state.memos.length && !isLoading ? <Card><Text>아직 저장된 메모가 없습니다.</Text></Card> : null}
                  </MemoList>
                </Stack>
              </Section>
            </Stack>
